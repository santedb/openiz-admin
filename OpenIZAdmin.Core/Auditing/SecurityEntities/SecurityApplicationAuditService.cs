...
namespace OpenIZAdmin.Core.Auditing.SecurityEntities
{
	...
	/// </summary>
	public class SecurityApplicationAuditService : SecurityEntityAuditServiceBase<SecurityApplication>, ISecurityEntityAuditService<SecurityApplication>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SecurityApplicationAuditService"/> class.
		/// </summary>
		/// <param name="context">The context.</param>
		public SecurityApplicationAuditService(HttpContext context) : base(context)
		{
		}
		...
		public AuditCode CreateSecurityEntityAuditCode => new AuditCode("SecurityApplicationCreated", "OpenIZAdminOperations") { DisplayName = "Create" };

		/// <summary>
		/// Gets the delete security entity audit code.
		/// </summary>
		/// <value>The delete security entity audit code.</value>
		public AuditCode DeleteSecurityEntityAuditCode => new AuditCode("SecurityApplicationDeleted", "OpenIZAdminOperations") { DisplayName = "Delete" };

		/// <summary>
		/// Gets the query security entity audit code.
		/// </summary>
		/// <value>The query security entity audit code.</value>
		public AuditCode QuerySecurityEntityAuditCode => new AuditCode("SecurityApplicationQueried", "OpenIZAdminOperations") { DisplayName = "Query" };

		/// <summary>
		/// Gets the update security entity audit code.
		/// </summary>
		/// <value>The update security entity audit code.</value>
		public AuditCode UpdateSecurityEntityAuditCode => new AuditCode("SecurityApplicationUpdated", "OpenIZAdminOperations") { DisplayName = "Update" };
		...
		public void AuditCreateSecurityEntity(OutcomeIndicator outcomeIndicator, SecurityApplication securityEntity)
		{
		...
		/// <param name="outcomeIndicator">The outcome indicator.</param>
		/// <param name="securityEntity">The security entity.</param>
		public void AuditDeleteSecurityEntity(OutcomeIndicator outcomeIndicator, SecurityApplication securityEntity)
		{
		...
		public void AuditQuerySecurityEntity(OutcomeIndicator outcomeIndicator, IEnumerable<SecurityApplication> securityEntities)
		{
		...
		/// <param name="outcomeIndicator">The outcome indicator.</param>
		/// <param name="securityEntity">The security entity.</param>
		public void AuditUpdateSecurityEntity(OutcomeIndicator outcomeIndicator, SecurityApplication securityEntity)
		{
