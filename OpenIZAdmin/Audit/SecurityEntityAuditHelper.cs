...
namespace OpenIZAdmin.Audit
{
	...
	public abstract class SecurityEntityAuditHelper<T> : HttpContextAuditHelperBase where T : SecurityEntity
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SecurityEntityAuditHelper{T}" /> class.
		/// </summary>
		/// <param name="credentials">The credentials.</param>
		/// <param name="context">The context.</param>
		protected SecurityEntityAuditHelper(Credentials credentials, HttpContext context) : base(credentials, context)
		{
		}
