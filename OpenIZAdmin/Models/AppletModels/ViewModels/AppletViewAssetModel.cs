...
namespace OpenIZAdmin.Models.AppletModels.ViewModels
{
	...
	public class AppletViewAssetModel
	{
		...
		public AppletViewAssetModel(AppletAsset appletAsset)
		{
			...
			this.Name = appletAsset.Name;
			this.MimeType = appletAsset.MimeType;
			this.Language = appletAsset.Language;
			this.Policies = appletAsset.Policies;
		}
