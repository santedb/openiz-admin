...
namespace OpenIZAdmin.Models.BusinessRuleModels.ViewModels
{
	/// <summary>
	...
	{
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessRuleViewModel"/> class.
        /// </summary>
        public BusinessRuleViewModel()
		{
		}
        ...
        public BusinessRuleViewModel(string author, string group, string id, string name, string version)
		{
			this.Author = author;
			this.Group = group;
			this.Id = id;
