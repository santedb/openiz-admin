...
namespace OpenIZAdmin.Models.OrganizationModels
{
	...
	public class OrganizationSearchResultViewModel : EntityViewModel
	{
		...
		public OrganizationSearchResultViewModel(OpenIZ.Core.Model.Entities.Organization organization) : base(organization)
		{
			this.CreationTime = organization.CreationTime.DateTime;
		}

		/// <summary>
		/// Gets or sets the creation time of the organization.
		/// </summary>
