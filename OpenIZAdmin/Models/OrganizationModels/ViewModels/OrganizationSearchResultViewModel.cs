...
namespace OpenIZAdmin.Models.OrganizationModels.ViewModels
{
	/// <summary>
	/// Represents an organization search result view model.
	/// </summary>
	public class OrganizationSearchResultViewModel
	{
		/// <summary>
		...
		public OrganizationSearchResultViewModel(Organization organization)
		{
